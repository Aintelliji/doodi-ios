                    ...
                    ScrollView {
                        VStack(spacing: 8) {
                            ForEach(messages) { msg in
                                ...
                                if(msg.isActivity){
                                    Button{
                                        path.append(ViewPath(type: .timerView(activity: ActivityDto(activityId: 0, activityIconUrl: "", activityName: "", activityDescription: "", typeId: 1, totalTime: 0, remainingTime: 0))))
                                    } label: {
