...
//    
//    init(path: [ViewPath], activityId: Float) {
//        _timerViewModel = StateObject(wrappedValue: TimerViewModel(activityId: activityId))
//        self.path = [ViewPath(type: .timerView(activityId: activityId), timerValue: activityId)]
//    }
//    
//    
//    var body: some View {
